...
const ProjectAllocation2 = () => {
    ...
    const onSubmit = async (formData) => {
        try {
            ...
            if (isEdit) {
                ...
                console.log("dataToInsert 1", dataToInsert)
                setFormLoading(true)
    ...
    console.log("allocatedUtilizationData", allocatedUtilizationData)
    console.log("Tos earch Date",sDate,eDate)
    console.log('Allocaton DAta',projectAllocationData)
                                    ...
                                    <Table.Body>
                                        {
                                            billAndUtiData.map((bAndU, i) => {
                                                console.log("Bill and Uti data",billAndUtiData)
                                                return (
                                                    <Table.Row key={i}>
